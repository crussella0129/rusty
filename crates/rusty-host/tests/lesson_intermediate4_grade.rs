//! End-to-end grading of intermediate lesson 4 (Smart Pointers & Shared State).
...
fn sandbox_from(which: &str, tag: &str) -> PathBuf {
    ...
    let dst = std::env::temp_dir().join(format!("rusty_s25_{tag}_{nanos}_{n}"));
...
const STEP3_EXPECTED: &str = "5 + 10 = 15\n(2 + 3) * 4 = 20";
...
#[test]
fn test_intermediate4_step2_faded_solution_passes() {
...
#[test]
fn test_intermediate4_step3_open_solution_passes() {
